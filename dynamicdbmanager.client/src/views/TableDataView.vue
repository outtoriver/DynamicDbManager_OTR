        ...
        <table v-else class="data-table">
          <thead>
            <tr>
              ...
              <th class="actions-col" aria-label="Удаление записи"></th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="row in paginatedRows" :key="row.id" @dblclick="editRow(row)">
              ...
              <td class="actions-col">
                <button type="button" class="row-delete" title="Удалить запись" aria-label="Удалить запись" @click.stop="deleteRow(row.id)">×</button>
              </td>
            </tr>
          </tbody>
        </table>
...
.data-table .actions-col .row-actions{display:flex;align-items:center;justify-content:center;gap:0;width:100%;}
...
/* Keep delete control in its own right-side sticky area, even when the table has only a few columns. */
.data-table{width:max-content;min-width:100%;}
.data-table .actions-col{width:42px;min-width:42px;max-width:42px;position:sticky;right:0;z-index:8;padding:0 6px !important;text-align:center;vertical-align:middle;box-sizing:border-box;box-shadow:-10px 0 18px rgba(0,0,0,.12);}
.data-table thead .actions-col{z-index:10;background:var(--table-head-bg,#0b0f17);}
.data-table tbody .actions-col{background:var(--table-actions-bg,var(--table-row-bg,#06090e));}
.data-table tbody tr:hover .actions-col{background:var(--table-row-hover,#0d1420);}
.row-delete{width:28px;height:28px;margin:0 auto;display:flex;align-items:center;justify-content:center;border:0;border-radius:8px;background:transparent;color:var(--app-danger,#ef4444);font-size:20px;font-weight:400;line-height:1;cursor:pointer;transition:background .16s ease,color .16s ease,transform .16s ease,opacity .16s ease;box-sizing:border-box;opacity:.9;}
.row-delete:hover{background:color-mix(in srgb,var(--app-danger,#ef4444) 11%,transparent);color:var(--app-danger,#ef4444);transform:scale(1.08);opacity:1;}
.row-delete:focus-visible{outline:none;background:color-mix(in srgb,var(--app-danger,#ef4444) 11%,transparent);color:var(--app-danger,#ef4444);box-shadow:0 0 0 3px color-mix(in srgb,var(--app-danger,#ef4444) 12%,transparent);opacity:1;}
@media(max-width:640px){.data-table .actions-col{width:42px;min-width:42px;max-width:42px;padding:0 3px !important;}.row-delete{width:30px;height:30px;font-size:21px;}}
/* Final row-action refinement: the rightmost data column remains fully resizable; delete stays a tiny fixed red control on the far right. */
.data-table th.data-column-head:last-of-type .column-resizer{right:-5px;}
.data-table .actions-col{width:42px;min-width:42px;max-width:42px;}
.data-table .actions-col .row-delete{width:28px;min-width:28px;height:28px;padding:0;color:var(--app-danger,#ef4444);background:transparent;border:0;}
.data-table .actions-col .row-delete:hover{color:var(--app-danger,#ef4444);background:color-mix(in srgb,var(--app-danger,#ef4444) 10%,transparent);}
