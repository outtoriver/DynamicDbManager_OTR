...
function draw(now) {
  ...
  gradient.addColorStop(0.45, '#0b1230')
  gradient.addColorStop(1, '#04060d')
  ctx.fillStyle = gradient
  ctx.fillRect(0, 0, width, height)

  const blobs = [
    { x: 0.18, y: 0.20, r: 0.42, c: 'rgba(99,102,241,.26)', s: 1.0 },
    { x: 0.78, y: 0.18, r: 0.34, c: 'rgba(34,211,238,.20)', s: .9 },
    { x: 0.62, y: 0.82, r: 0.45, c: 'rgba(168,85,247,.22)', s: 1.1 },
    { x: 0.28, y: 0.72, r: 0.30, c: 'rgba(16,185,129,.13)', s: .8 }
  ]
