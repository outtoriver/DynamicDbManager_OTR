...
function buildGalaxy(profile, theme = currentTheme()) {
  ...
  for (let i = 0; i < bgStarCount; i++) {
    ...
    if (theme === 'light') {
      bgColors[i3] = brightness * 0.25
      bgColors[i3 + 1] = brightness * 0.35
      bgColors[i3 + 2] = brightness * 0.62
    } else {
